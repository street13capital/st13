...
It is still in Pre-Alpha, the framework for downloading data, plotting log chart with trendlines is done. Originally, my next steps would be improving the trendlines detection and plotting, before coding in price behaviour analysis.
